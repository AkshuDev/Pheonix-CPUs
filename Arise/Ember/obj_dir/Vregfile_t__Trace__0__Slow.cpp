...
VL_ATTR_COLD void Vregfile_t___024root__trace_init_sub__TOP__0(Vregfile_t___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_init_sub__TOP__0\n"); );
    ...
    tracep->declBus(c+2,0,"wr1_addr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declQuad(c+3,0,"wr1_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    ...
    tracep->declQuad(c+7,0,"rd1_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    ...
    tracep->declBus(c+5,0,"temp_buf",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+2,0,"wr1_addr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declQuad(c+3,0,"wr1_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    ...
    tracep->declQuad(c+7,0,"rd1_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
...
VL_ATTR_COLD void Vregfile_t___024root__trace_init_top(Vregfile_t___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_init_top\n"); );
    Vregfile_t__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vregfile_t___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vregfile_t___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vregfile_t___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void Vregfile_t___024root__trace_register(Vregfile_t___024root* vlSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_register\n"); );
    Vregfile_t__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vregfile_t___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vregfile_t___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vregfile_t___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vregfile_t___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vregfile_t___024root__trace_const_0_sub_0(Vregfile_t___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vregfile_t___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_const_0\n"); );
    // Init
    Vregfile_t___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vregfile_t___024root*>(voidSelf);
    Vregfile_t__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vregfile_t___024root__trace_const_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vregfile_t___024root__trace_const_0_sub_0(Vregfile_t___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_const_0_sub_0\n"); );
    Vregfile_t__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vregfile_t___024root__trace_full_0_sub_0(Vregfile_t___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vregfile_t___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_full_0\n"); );
    // Init
    Vregfile_t___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vregfile_t___024root*>(voidSelf);
    Vregfile_t__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vregfile_t___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vregfile_t___024root__trace_full_0_sub_0(Vregfile_t___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile_t___024root__trace_full_0_sub_0\n"); );
    Vregfile_t__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullBit(oldp+1,(vlSelfRef.regfile_test__DOT__wr_en));
    bufp->fullCData(oldp+2,(vlSelfRef.regfile_test__DOT__wr1_addr),5);
    bufp->fullQData(oldp+3,(vlSelfRef.regfile_test__DOT__wr1_data),64);
    bufp->fullIData(oldp+5,(vlSelfRef.regfile_test__DOT__temp_buf),32);
    bufp->fullIData(oldp+6,(vlSelfRef.regfile_test__DOT__i),32);
    bufp->fullQData(oldp+7,((((0x13U > (IData)(vlSelfRef.regfile_test__DOT__rd1_addr)) 
                              ...
                              ? ((0x12U >= (IData)(vlSelfRef.regfile_test__DOT__rd1_addr))
                                 ...
                                 [vlSelfRef.regfile_test__DOT__rd1_addr]
                                  : 0ULL) : 0ULL)),64);
    bufp->fullQData(oldp+9,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[0]),64);
    bufp->fullQData(oldp+11,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[1]),64);
    bufp->fullQData(oldp+13,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[2]),64);
    bufp->fullQData(oldp+15,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[3]),64);
    bufp->fullQData(oldp+17,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[4]),64);
    bufp->fullQData(oldp+19,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[5]),64);
    bufp->fullQData(oldp+21,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[6]),64);
    bufp->fullQData(oldp+23,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[7]),64);
    bufp->fullQData(oldp+25,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[8]),64);
    bufp->fullQData(oldp+27,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[9]),64);
    bufp->fullQData(oldp+29,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[10]),64);
    bufp->fullQData(oldp+31,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[11]),64);
    bufp->fullQData(oldp+33,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[12]),64);
    bufp->fullQData(oldp+35,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[13]),64);
    bufp->fullQData(oldp+37,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[14]),64);
    bufp->fullQData(oldp+39,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[15]),64);
    bufp->fullQData(oldp+41,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[16]),64);
    bufp->fullQData(oldp+43,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[17]),64);
    bufp->fullQData(oldp+45,(vlSelfRef.regfile_test__DOT__uut__DOT__regs[18]),64);
