...
VL_ATTR_COLD void Vcore_t___024root__trace_init_sub__TOP__0(Vcore_t___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+64,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->pushPrefix("core_t", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+63,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+64,0,"reset",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+65,0,"load_program__Vstatic__i",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    ...
    tracep->declQuad(c+67,0,"rdest_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    ...
    tracep->declBit(c+69,0,"alu_flags",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declQuad(c+70,0,"FIXED_MEM_BASE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    ...
    tracep->declBus(c+75,0,"DATA_W",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+81,0,"NUM_REGS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declQuad(c+67,0,"rd2_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 63,0);
    tracep->popPrefix();
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vcore_t___024root__trace_const_0_sub_0(Vcore_t___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+65,(vlSelfRef.core_t__DOT__load_program__Vstatic__i),32);
    bufp->fullBit(oldp+66,(0U));
    bufp->fullQData(oldp+67,(vlSelfRef.core_t__DOT__dut__DOT__rdest_data),64);
    bufp->fullBit(oldp+69,(vlSelfRef.core_t__DOT__dut__DOT__alu_flags));
    bufp->fullQData(oldp+70,(0x1000ULL),64);
    bufp->fullIData(oldp+72,(vlSelfRef.core_t__DOT__dut__DOT__i),32);
    ...
    bufp->fullIData(oldp+80,(vlSelfRef.core_t__DOT__dut__DOT__dmem__DOT__i),32);
    bufp->fullIData(oldp+81,(0x22U),32);
}
...
VL_ATTR_COLD void Vcore_t___024root__trace_full_0_sub_0(Vcore_t___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+64,(vlSelfRef.reset));
}
